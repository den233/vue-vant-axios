<template>
  <div id="orderDetail">
     ...
     <div class="form">
        ...
        <van-field
          v-model="formItem.serviceMan"
          center
          clearable
          label="服务人编号"
          placeholder="服务人编号"
        >
        <van-button @click='nexHandle(1)' slot="button" size="small" type="primary">下一步</van-button>
       </van-field>  
        </van-cell-group>
        
        <van-tabs v-model="tabactive"  v-if='active==1'>
            <van-tab title="新会员">
                <van-cell-group>
                    <van-field
            ...
            <van-tab title="老会员">
                <van-cell-group>
                    <van-field
                      v-model="formItem.old.serviceNum"
                      center
                      clearable
                      label="服务机构编号"
                      placeholder="服务机构编号"
            ...
            <div class="layui-form-item funditem" >
                <label class='label' for="">是否使用创业基金</label>
         ...
         <div class="step3" v-if='active==2'>
            <van-cell-group>
                ...
                <van-field
                  :value="paylist.salesMan"
                  label="销售人编号"
                  left-icon="friends-o"
                  disabled
                />
                <van-field
                  :value="paylist.serviceMan"
                  label="服务人编号"
                  left-icon="manager-o"
                  disabled
                />
    ...
    <div class="footer">
      ...
      <van-button class="copy" style="width:auto"  v-clipboard:copy="footerInfo.orderNum"
