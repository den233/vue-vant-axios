...
@IonicPage({
    name: "frozenAccountDetail",
    segment: "frozenAccountDetail",
    defaultHistory: []
})
@Component({
  selector: 'page-frozen-account-detail',
  templateUrl: 'frozen-account-detail.html',
})
export class FrozenAccountDetailPage {
