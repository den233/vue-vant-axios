 ...
 */
@IonicPage({
  name: "servePerformance",
  segment: "servePerformance",
  defaultHistory: []
})
@Component({
  selector: 'page-serve-performance',
  templateUrl: 'serve-performance.html',
})
export class ServePerformancePage {
  userCode:string = '';
  ...
  goBack(){
     ...
     */
  terminal(num){
      this.navCtrl.push('servePerformanceTerminal',{userCode:num});
  }
