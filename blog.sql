...
CREATE TABLE IF NOT EXISTS `ls_categories` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `category_id` int(11) NOT NULL,
  `name` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `price` decimal(5,2) NOT NULL,
  `pv` decimal(5,2) NOT NULL,
  `number` int(11) NOT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci AUTO_INCREMENT=46 ;

--
-- 转存表中的数据 `ls_categories`
--

INSERT INTO `ls_categories` (`id`, `category_id`, `name`, `price`, `pv`, `number`, `created_at`, `updated_at`) VALUES
(45, 14, '办公家具', '600.00', '500.00', 1, NULL, NULL),
(44, 13, '空调家电', '600.00', '500.00', 1, NULL, NULL),
(43, 12, '电视剧', '600.00', '500.00', 1, NULL, NULL),
(42, 11, 'lv宝宝', '600.00', '500.00', 1, NULL, NULL),
(41, 10, '手机数码', '600.00', '500.00', 1, NULL, NULL),
(40, 9, '学习用品', '600.00', '500.00', 1, NULL, NULL),
(39, 8, '毛绒玩具', '600.00', '500.00', 1, NULL, NULL),
(38, 7, '眼睛', '600.00', '500.00', 1, NULL, NULL),
(37, 6, '格力', '600.00', '500.00', 1, NULL, NULL),
(36, 5, '美的', '600.00', '500.00', 1, NULL, NULL),
(35, 4, '魔力鞋', '600.00', '500.00', 1, NULL, NULL),
(34, 3, '保健品', '600.00', '500.00', 1, NULL, NULL),
(33, 2, '牙膏', '600.00', '500.00', 1, NULL, NULL),
(32, 1, '运动鞋', '600.00', '500.00', 1, NULL, NULL),
(31, 11, '洗发水', '600.00', '500.00', 1, NULL, NULL);
...
CREATE TABLE IF NOT EXISTS `ls_content` (
  `id` int(10) NOT NULL AUTO_INCREMENT,
...
(30, '2', 1, '3', NULL, 0, 99, 'page', '', '4', '<p>4</p>\n', 1542086225, 1542086278, 0),
(31, '1', 1, 'c01271df338af66185cbf7083f29e8ff', NULL, 2, 99, 'post', '', '', '', 1542088526, 1542088526, 6);
...
INSERT INTO `ls_goods` (`id`, `category_id`, `name`, `price`, `pv`, `number`, `created_at`, `updated_at`) VALUES
(1, 11, '健康排毒营奢华套餐', '600.00', '500.00', 1, NULL, NULL),
(2, 11, '节日有礼组合', '600.00', '500.00', 1, NULL, NULL),
(3, 11, '固定1000SV小分子蛋白肽...', '600.00', '500.00', 1, NULL, NULL),
(4, 11, '董事长推荐13000元套餐三', '600.00', '500.00', 1, NULL, NULL),
(5, 11, '董事长推荐13000元套餐一', '600.00', '500.00', 1, NULL, NULL),
(6, 11, '董事长推荐13000元套餐二', '600.00', '500.00', 1, NULL, NULL),
(7, 11, '董事长推荐13000元套餐四', '600.00', '500.00', 1, NULL, NULL),
(8, 11, '小分子蛋白肽钜惠套餐', '600.00', '500.00', 1, NULL, NULL),
(9, 11, '天天有礼组合', '600.00', '500.00', 1, NULL, NULL),
(10, 11, '圣萝蔓驻颜肤水面膜', '600.00', '500.00', 1, NULL, NULL),
(11, 11, '雅璨诗肽兰美丽三宝3件套', '600.00', '500.00', 1, NULL, NULL),
(12, 11, '雅璨双重滋养白金系列套装（七件套）', '600.00', '500.00', 1, NULL, NULL),
(13, 11, '雅璨诗肽兰安肤平衡调理霜', '600.00', '500.00', 1, NULL, NULL),
(14, 11, '雅璨50g男士净爽紧肤霜', '600.00', '500.00', 1, NULL, NULL),
(15, 11, '雅璨璀璨嫩肤滋润乳液', '600.00', '500.00', 1, NULL, NULL),
(16, 11, '榭丽舍昂庄园漫步干红葡萄酒', '600.00', '500.00', 1, NULL, NULL),
(17, 11, '榭丽舍昂庄园漫步桃红葡萄酒', '600.00', '500.00', 1, NULL, NULL),
(18, 11, '清欣“九层双芯”超薄卫生巾组合装', '600.00', '500.00', 1, NULL, NULL),
(19, 1, '运动鞋', '600.00', '500.00', 1, NULL, NULL),
(20, 2, '牙膏', '600.00', '500.00', 1, NULL, NULL),
(21, 3, '保健品', '600.00', '500.00', 1, NULL, NULL),
(22, 4, '魔力鞋', '600.00', '500.00', 1, NULL, NULL),
(23, 5, '美的', '600.00', '500.00', 1, NULL, NULL),
(24, 6, '格力', '600.00', '500.00', 1, NULL, NULL),
(25, 7, '眼睛', '600.00', '500.00', 1, NULL, NULL),
(26, 8, '毛绒玩具', '600.00', '500.00', 1, NULL, NULL),
(27, 9, '学习用品', '600.00', '500.00', 1, NULL, NULL),
(28, 10, '手机数码', '600.00', '500.00', 1, NULL, NULL),
(29, 11, 'lv宝宝', '600.00', '500.00', 1, NULL, NULL),
(30, 12, '电视剧', '600.00', '500.00', 1, NULL, NULL),
(31, 13, '空调家电', '600.00', '500.00', 1, NULL, NULL),
(32, 14, '办公家具', '600.00', '500.00', 1, NULL, NULL);
...
(20, 1, '1', '2', '3', 'category', 0, 0),
(21, 1, '1', '2', '3', 'category', 0, 0),
(22, 1, '22', '2', '22111', 'category', 0, 0),
(23, 1, '22', '2', '22111', 'category', 0, 0),
(24, 1, '', NULL, NULL, '', 0, 0),
(25, 1, '1122', '2', 'wwww', 'category', 0, 0),
(26, 1, 'dd', '2', '333', 'category', 0, 0),
(27, 1, 'dd', '2', '333', 'category', 0, 0),
(28, 1, 'dd', '2', '333', 'category', 0, 0),
(29, 1, 'dd', '2', '333', 'category', 0, 0);
...
--
-- 转存表中的数据 `ls_migrations`
--

INSERT INTO `ls_migrations` (`id`, `migration`, `batch`) VALUES
(5, '2014_10_12_100000_create_password_resets_table', 1),
(9, '2018_12_14_014134_create_categories_table', 2),
(10, '2018_12_14_042955_create_goods_table', 2);

-- --------------------------------------------------------

--
-- 表的结构 `ls_password_resets`
--

CREATE TABLE IF NOT EXISTS `ls_password_resets` (
...
CREATE TABLE IF NOT EXISTS `ls_relationship` (
...
(1, 'admin', NULL, '', NULL, NULL, NULL, '24d8cee9ed793b9f818b6c4b67aae9aa', 'Mje5sowT7', 1542760702);
